...
<?php
$sql1 = "SELECT siparis.Cesit, COUNT(siparis.siparisID) as siparissayisi FROM siparis GROUP BY siparis.Cesit;";
...
<?php
$sql2 = "SELECT siparis.Koken, COUNT(siparis.siparisID) as siparissayisi FROM siparis GROUP BY siparis.Koken;";
...
<?php
$sql3 = "SELECT siparis.Cesit, COUNT(siparis.siparisID) as siparissayisi 
FROM siparis 
WHERE siparis.ilceadi = 'Karşıyaka' 
GROUP BY siparis.Cesit 
...
$dynamicData3[] = array('name' => $row3['Cesit'], 'value' => $row3['siparissayisi']);
}
?>
...
option3 = {
    title: {
        text: 'Karşıyaka İlçesinde En Çok Tercih Edilen Çeşitler',
        left: 'center'
    },
    tooltip: {
        trigger: 'item'
...
<script type="text/javascript">
    ...
    <?php
    $sql5 = "SELECT siparis.ilceadi, COUNT(siparis.siparisID) as siparissayisi FROM siparis GROUP BY siparis.ilceadi;";
    $result5 = mysqli_query($link, $sql5);

    $dynamicData5 = array();
    while ($row5 = mysqli_fetch_assoc($result5)) {
        $dynamicData5[] = array('name' => $row5['ilceadi'], 'value' => $row5['siparissayisi']);
    }
    ?>
    ...
    var option5 = {
        title: {
            top: '90%',
            text: 'En Çok Satış Yapılan İlçeler',
            left: 'center'
        },
        tooltip: {
            trigger: 'axis'
...
<?php
"SELECT siparis.iladi, COUNT(siparis.siparisID) as siparissayisi FROM siparis GROUP BY siparis.iladi;";
$sqlBarChart = "SELECT siparis.iladi, COUNT(siparis.siparisID) as siparissayisi FROM siparis GROUP BY siparis.iladi;";
$resultBarChart = mysqli_query($link, $sqlBarChart);

$dynamicDataBarChart = array();
while ($rowBarChart = mysqli_fetch_assoc($resultBarChart)) {
    $dynamicDataBarChart[] = array(
        'name' => $rowBarChart['iladi'],
...
<script type="text/javascript">
        ...
        optionBarChart = {
            title: {
                top: '90%',
                text: 'En Çok Satış Yapılan İller',
                left: 'center'
            },
            tooltip: {
                trigger: 'item'
